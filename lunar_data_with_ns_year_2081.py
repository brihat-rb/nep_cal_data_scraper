...
OUT_FILE = "2081_lunar_data.json"
# OUT_FILE_2 = "2081_detailed.json"
YEAR = 2081
...
def get_lunar_month(date):
    ''' only valid  for 2081 BS '''
    date_split = date.split("-")
    date_month = int(date_split[1])
    date_day = int(date_split[2])

    if date_month == 1 and (date_day >= 1 and date_day <= 12):
        return lunar_month_list[0]
    elif date_month == 1 and (date_day >= 13 and date_day <= 26):
        return lunar_month_list[1]
    elif (date_month == 1 and (date_day >= 27 and date_day <= 31)) or (date_month == 2 and (date_day >= 1 and date_day <= 10)):
        return lunar_month_list[2]
    elif date_month == 2 and (date_day >= 11 and date_day <= 24):
        return lunar_month_list[3]
    elif date_month == 2 and (date_day >= 25 and date_day <= 32) or (date_month == 3 and (date_day >= 1 and date_day <= 8)):
        return lunar_month_list[4]
    elif date_month == 3 and (date_day >= 9 and date_day <= 21):
        return lunar_month_list[5]
    elif date_month == 3 and (date_day >= 22 and date_day <= 31) or (date_month == 4 and (date_day >= 1 and date_day <= 6)):
        return lunar_month_list[6]
    elif (date_month == 4 and (date_day >= 7 and date_day <= 20)):
        return lunar_month_list[7]
    elif (date_month == 4 and (date_day >= 21 and date_day <= 32)) or (date_month == 5 and (date_day >= 1 and date_day <= 3)):
        return lunar_month_list[8]
    elif date_month == 5 and (date_day >= 4 and date_day <= 18):
        return lunar_month_list[9]
    elif (date_month == 5 and (date_day >= 19 and date_day <= 31)) or (date_month == 6 and (date_day >= 1 and date_day <= 2)):
        return lunar_month_list[10]
    elif date_month == 6 and (date_day >= 3 and date_day <= 16):
        return lunar_month_list[11]
    elif (date_month == 6 and (date_day >= 17 and date_day <= 30)) or (date_month == 7 and (date_day >= 1 and date_day <= 1)):
        return lunar_month_list[12]
    elif date_month == 7 and (date_day >= 2 and date_day <= 16):
        return lunar_month_list[13]
    elif (date_month == 7 and (date_day >= 17 and date_day <= 30)):
        return lunar_month_list[14]
    elif date_month == 8 and (date_day >= 1 and date_day <= 16):
        return lunar_month_list[15]
    elif (date_month == 8 and (date_day >= 17 and date_day <= 30)):
        return lunar_month_list[16]
    elif date_month == 9 and (date_day >= 1 and date_day <= 15):
        return lunar_month_list[17]
    elif (date_month == 9 and (date_day >= 16 and date_day <= 29)):
        return lunar_month_list[18]
    elif date_month == 10 and (date_day >= 1 and date_day <= 16):
        return lunar_month_list[19]
    elif (date_month == 10 and (date_day >= 17 and date_day <= 30)):
        return lunar_month_list[20]
    elif date_month == 11 and (date_day >= 1 and date_day <= 16):
        return lunar_month_list[21]
    elif (date_month == 11 and (date_day >= 17 and date_day <= 29)) or (date_month == 12 and (date_day >= 1 and date_day <= 1)):
        return lunar_month_list[22]
    elif date_month == 12 and (date_day >= 2 and date_day <= 16):
        return lunar_month_list[23]
    elif date_month == 12 and (date_day >= 17 and date_day <= 30):
        return lunar_month_list[24]
    elif date_month == 12 and (date_day == 31):
...
def get_pakshya(date):
    ...
    elif date_month == 12 and (date_day >= 17 and date_day <= 31):
