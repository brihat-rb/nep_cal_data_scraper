...
OUT_FILE = "2078_lunar_data.json"
# OUT_FILE_2 = "2078_detailed.json"
YEAR = 2078
...
def get_lunar_month(date):
    ...
    if date_month == 1 and (date_day >= 1 and date_day <= 14):
        return lunar_month_list[0]
    elif date_month == 1 and (date_day >= 15 and date_day <= 28):
        return lunar_month_list[1]
    elif (date_month == 1 and (date_day >= 29 and date_day <= 31)) or (date_month == 2 and (date_day >= 1 and date_day <= 12)):
        return lunar_month_list[2]
    elif date_month == 2 and (date_day >= 13 and date_day <= 27):
        return lunar_month_list[3]
    elif date_month == 2 and (date_day >= 28 and date_day <= 31) or (date_month == 3 and (date_day >= 1 and date_day <= 10)):
        return lunar_month_list[4]
    elif date_month == 3 and (date_day >= 11 and date_day <= 26):
        return lunar_month_list[5]
    elif date_month == 3 and (date_day >= 27 and date_day <= 31) or (date_month == 4 and (date_day >= 1 and date_day <= 9)):
        return lunar_month_list[6]
    elif date_month == 4 and (date_day >= 10 and date_day <= 24):
        return lunar_month_list[7]
    elif date_month == 4 and (date_day >= 25 and date_day <= 32) or (date_month == 5 and (date_day >= 1 and date_day <= 6)):
        return lunar_month_list[8]
    elif date_month == 5 and (date_day >= 7 and date_day <= 22):
        return lunar_month_list[9]
    elif date_month == 5 and (date_day >= 23 and date_day <= 31) or (date_month == 6 and (date_day >= 1 and date_day <= 4)):
        return lunar_month_list[10]
    elif date_month == 6 and (date_day >= 5 and date_day <= 20):
        return lunar_month_list[11]
    elif date_month == 6 and (date_day >= 21 and date_day <= 31) or (date_month == 7 and (date_day >= 1 and date_day <= 3)):
        return lunar_month_list[12]
    elif date_month == 7 and (date_day >= 4 and date_day <= 18):
        return lunar_month_list[13]
    elif date_month == 7 and (date_day >= 19 and date_day <= 30) or (date_month == 8 and (date_day >= 1 and date_day <= 3)):
        return lunar_month_list[14]
    elif date_month == 8 and (date_day >= 4 and date_day <= 18):
        return lunar_month_list[15]
    elif date_month == 8 and (date_day >= 19 and date_day <= 29) or (date_month == 9 and (date_day >= 1 and date_day <= 4)):
        return lunar_month_list[16]
    elif date_month == 9 and (date_day >= 5 and date_day <= 18):
        return lunar_month_list[17]
    elif date_month == 9 and (date_day >= 19 and date_day <= 30) or (date_month == 10 and (date_day >= 1 and date_day <= 3)):
        return lunar_month_list[18]
    elif date_month == 10 and (date_day >= 4 and date_day <= 18):
        return lunar_month_list[19]
    elif date_month == 10 and (date_day >= 19 and date_day <= 29) or (date_month == 11 and (date_day >= 1 and date_day <= 4)):
        return lunar_month_list[20]
    elif date_month == 11 and (date_day >= 5 and date_day <= 18):
        return lunar_month_list[21]
    elif date_month == 11 and (date_day >= 19 and date_day <= 30) or (date_month == 12 and (date_day >= 1 and date_day <= 4)):
        return lunar_month_list[22]
    elif date_month == 12 and (date_day >= 5 and date_day <= 18):
        return lunar_month_list[23]
    elif date_month == 12 and (date_day >= 19 and date_day <= 30):
